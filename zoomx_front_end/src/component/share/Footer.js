  ...
  return (
    <>
      <footer>
                        ...
                        <li>
                          ...
                          >
                            <path
                              ...
                              d="M21.188,0H2.813A2.816,2.816,0,0,0,0,2.813V21.188A2.816,2.816,0,0,0,2.813,24H21.188A2.816,2.816,0,0,0,24,21.188V2.813A2.816,2.816,0,0,0,21.188,0Zm.938,21.188a.939.939,0,0,1-.937.938H15.656V15.281h3l.35-2.906H15.656V9.234a1.375,1.375,0,0,1,1.406-1.406h2.109V5.109a20.849,20.849,0,0,0-2.109-.187,4.34,4.34,0,0,0-3.007,1.265A4.268,4.268,0,0,0,12.75,9.243v3.132H9.7v2.906H12.75v6.844H2.813a.939.939,0,0,1-.937-.937V2.813a.939.939,0,0,1,.938-.937H21.188a.939.939,0,0,1,.938.938Zm0,0"
                              fill="#fff"
                            />
                          </svg>
                        </li>
                            ...
                            <g id="Group_1788" data-name="Group 1788">
                              <g id="Group_1787" data-name="Group 1787">
                                <path
                                  id="Path_1696"
                                  data-name="Path 1696"
                                  d="M17.752,0H6.356A6.289,6.289,0,0,0,0,6.357v11.4A6.289,6.289,0,0,0,6.356,24.11h11.4a6.29,6.29,0,0,0,6.358-6.357V6.357A6.29,6.29,0,0,0,17.752,0Zm4.8,17.753a4.7,4.7,0,0,1-4.8,4.8H6.356a4.7,4.7,0,0,1-4.8-4.8V6.357a4.7,4.7,0,0,1,4.8-4.8h11.4a4.7,4.7,0,0,1,4.8,4.8Z"
                                  fill="#fff"
                                />
                              </g>
                            </g>
        ...
        <div className="col-lg-4 col-md-6 col-6  wrapper__top__item">
          <div>
            <div className="wrapper__top__item--top">Liên hệ với chúng tôi</div>
            <div className="wrapper__top__item--mid">MẠNG XÃ HỘI</div>
            <div className="wrapper__top__item--bottom">
              <ul>
                <li>
        ...
        <div className="col-lg-4 col-md-8 col-sm-12 wrapper__top__item">
          <div className="wrapper__top__item--top">Tin mới</div>
          <div className="wrapper__top__item--mid">ĐĂNG KÝ NHẬN THÔNG BÁO</div>
          <div className="wrapper__top__item--bottom sign__wrapper">
            <div className="sign__wrapper__input">
              <input type="email" placeholder="Email" />
            </div>
