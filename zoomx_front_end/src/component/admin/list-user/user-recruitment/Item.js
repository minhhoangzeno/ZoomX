...
export default function Item({ indexNum, data, getData, handleLoading }) {
    ...
    const deleteUser = async () => {
        handleLoading(true)
        const path = `/person-recruitment/${data._id}`;
        try {
    ...
    return (
        <>
            <tr >
                ...
                <td className="text-center" style={{ verticalAlign: 'middle' }}>{data?.career}</td>
                <td className="text-center" style={{ verticalAlign: 'middle' }}>{data.addressWork}</td>
                ...
                <td className="text-center" style={{ verticalAlign: 'middle' }}>
                    <a href={data?.fileCv.fileUrl}>CV</a>
                </td>
