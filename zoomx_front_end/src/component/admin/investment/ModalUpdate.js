        ...
        <>
            ...
            >
                <div className="wrapper__modal">
                    <div>
                        <label className="label-txt">Tên lĩnh vực đầu tư: </label> <input className="input-txt"
                    ...
                    <div>
                        <label className="label-txt">Mô tả lĩnh vực đầu tư: </label> <input className="input-txt"
