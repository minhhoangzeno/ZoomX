...
export default function ModalUpdate(props) {
  const [fileCover, setFileCover] = useState(
    props.dataInvestment.imageCover.url
  );
    ...
    <>
      ...
      >
        <div className="wrapper__modal">
          <div>
            <label className="label-txt">Nhập linh vuc dau tu: </label>{" "}
            <input
              className="input-txt"
              name="investmentName"
          ...
          <div>
            <label className="label-txt">Nhập mo ta linh vuc dau tu: </label>{" "}
            <input
              className="input-txt"
              name="description"
              onChange={handleInvestment}
          ...
          <div>
            <label>Anh linh vuc dau tu:</label>{" "}
            <input
              id="file-input"
              type="file"
              name="imageCover"
