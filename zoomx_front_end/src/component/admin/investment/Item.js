  ...
  return (
    <>
      <tr>
        ...
        <td className="text-center" style={{ verticalAlign: "middle" }}>
          {dataInvestment?.investmentName}
        </td>
        <td className="text-center" style={{ verticalAlign: "middle" }}>
          {dataInvestment?.description}
        </td>
        <td className="text-center" style={{ verticalAlign: "middle" }}>
          <img
            alt=""
            src={dataInvestment?.imageCover?.url}
        ...
        <td className="text-center">
          <div>
            <input
              ...
              name={dataInvestment._id}
              checked={dataInvestment.isDeleted ? false : true}
            />{" "}
            Hoạt động
          </div>
          <div>
            <input
              type="radio"
              onChange={() => handleDeleteInvestment()}
              name={dataInvestment._id}
              checked={dataInvestment.isDeleted ? true : false}
            />{" "}
            Không Hoạt động
          </div>
        </td>
