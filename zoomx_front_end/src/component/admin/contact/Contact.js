                    ...
                    <table id="example1" className="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Thành phố</th>
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Điện thoại</th>
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Email</th>
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Thời gian Hotline</th>
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Hotline</th>
                        ...
                        {!loading ?
                            <tbody>
                                {data?.map((item, index) => {
                                    return (
                                        <Item dataContact={item} key={index} handleLoading={handleLoading} indexNum={index + 1} getContact={getContact} />
                                    )
                                })}
                            </tbody>
                            : <Loading />
