                    ...
                    <table id="example1" className="table table-bordered table-striped">
                        ...
                        {!loading ?
                            <tbody>
                                {data?.map((item, index) => {
                                    return (
                                        <Item dataDefineHome={item} key={index} handleLoading={handleLoading} indexNum={index + 1} getDefineHome={getDefineHome} />
                                    )
                                })}
                            </tbody>
                            : <Loading />
