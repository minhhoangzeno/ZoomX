              ...
              <div className="introduce-detail">
                ...
                <div className="introduce-detail__content">
                  <p>
                    ...
                    hạn. Áp dụng lực đẩy Archimedes và hệ thống trục định tâm,
                    dự án sẽ đưa du khách đến những trải nghiệm nghỉ dưỡng hoàn
                    toàn mới lạ và khác biệt.
                  </p>
                  <p>
                    Chất lượng dịch vụ đảm bảo tiêu chuẩn 4-5*, tiện ích đa
                    dạng, khách sạn quay ZoomX hứa hẹn là chốn dừng chân hoàn
                    hảo cho khách du lịch trong và ngoài nước.
                  </p>
                  <p>
                    Dự án được lên ý tưởng và xây dựng từ chính người Việt, mọi
                    chi tiết, thiết kế đều mang đậm dấu ấn văn hóa Việt Nam. Qua
                    đó, quảng bá được hình ảnh đất nước, văn hóa, con người Việt
